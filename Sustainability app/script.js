...
const translations = {
  en: {
    ...
    faqEyebrow: "Coastal Conservation & FAQ",
    faqTitle: "Frequently Asked Questions About UAE Beach Cleanups",
    faqIntro: "Essential guidance on volunteer participation, priority shoreline areas, marine debris management, and local environmental partnerships across the Emirates.",
    faqQ1: "How can volunteers join beach cleanups across Dubai, Abu Dhabi, and the UAE?",
    faqA1: "Volunteers can participate freely through Clean Shores UAE without any registration fees. Explore our Coastal Directory to locate active spots across Dubai, Abu Dhabi, Sharjah, and Ajman, or check the Community Wall for scheduled community sweeps. You can also organize your own sweep with friends, family, or colleagues, document your impact, and share your cleanup reports on our Community Wall.",
    faqQ2: "Which UAE beaches and coastal spots require the most urgent cleanup action?",
    faqA2: "Priority areas include high-footfall public beaches such as Jumeirah Open Beach and Kite Beach in Dubai, and Al Heera Beach in Sharjah, where single-use plastics and tourist litter frequently wash up. Crucially, sensitive ecological habitats such as the Saadiyat Marine & Coastal Reserve in Abu Dhabi (a vital Hawksbill turtle nesting habitat) and the Al Zorah Mangrove Coast in Ajman require gentle, non-intrusive microplastic sweeps and retrieval of entangled fishing ropes.",
    faqQ3: "What types of marine debris are most commonly found on UAE shorelines?",
    faqA3: "Audits from UAE coastal sweeps consistently identify single-use plastics (water bottles, bottle caps, straws, and snack wrappers), polystyrene/styrofoam foam flotsam, and discarded fishing lines or nets (ghost gear). Removing these materials prevents degradation into hazardous microplastics that threaten Arabian Gulf marine fauna and coral ecosystems.",
    faqQ4: "How does Clean Shores UAE coordinate with local environmental frameworks?",
    faqA4: "Clean Shores UAE is an independent grassroots platform that aligns with municipal environmental goals and UAE national sustainability agendas. Our cleanup activities support the guidelines and conservation initiatives promoted by Dubai Municipality, Tadweer Group (Abu Dhabi Waste Management), the Environment Agency – Abu Dhabi (EAD), and the Ministry of Climate Change and Environment (MOCCAE), reinforcing national single-use plastic reduction policies.",
    faqQ5: "How can UAE residents report or nominate a polluted shoreline?",
    faqA5: "Residents and visitors can nominate any neglected shoreline or mangrove inlet using our Community Wall form. Select 'Cleanup recommendation', specify the beach and Emirate, describe the debris type, and attach photos or videos. Verified submissions are mapped and prioritized for community volunteer mobilization.",
  ...
  ru: {
    ...
    faqEyebrow: "Защита побережья и FAQ",
    faqTitle: "Часто задаваемые вопросы об уборке пляжей в ОАЭ",
    faqIntro: "Основная информация об участии волонтёров, приоритетных прибрежных зонах, контроле морского мусора и взаимодействии с экологическими инициативами в Эмиратах.",
    faqQ1: "Как волонтёрам присоединиться к уборкам пляжей в Дубае, Абу-Даби и других эмиратах?",
    faqA1: "Волонтёры могут участвовать через Clean Shores UAE совершенно свободно и без регистрационных взносов. Изучите наш Каталог побережья для поиска активных точек в Дубае, Абу-Даби, Шардже и Аджмане, или проверяйте Стену сообщества, чтобы узнать о планируемых субботниках. Вы также можете организовать свою уборку с друзьями, коллегами или семьёй и опубликовать отчёт на нашей Стене сообщества.",
    faqQ2: "Каким пляжам и прибрежным зонам ОАЭ уборка требуется в первую очередь?",
    faqA2: "В приоритете находятся как популярные общественные пляжи с высоким турпотоком (Jumeirah Open Beach и Kite Beach в Дубае, Al Heera в Шардже), где скапливается одноразовый пластик, так и уязвимые природные экосистемы: морской заповедник Saadiyat в Абу-Даби (место гнездования черепах бисса) и мангровые заросли Al Zorah в Аджмане, требующие аккуратного сбора микропластика и брошенных рыболовных снастей.",
    faqQ3: "Какой морской мусор чаще всего встречается на побережье ОАЭ?",
    faqA3: "Прибрежные рейды чаще всего выявляют одноразовый пластик (бутылки для воды, крышки, трубочки и упаковку от снеков), куски пенопласта и брошенные лески или обрывки сетей. Своевременное удаление этих отходов предотвращает их распад на опасный микропластик, угрожающий морской фауне и кораллам Персидского залива.",
    faqQ4: "Как Clean Shores UAE взаимодействует с официальными экологическими структурами?",
    faqA4: "Clean Shores UAE — независимая общественная инициатива, поддерживающая муниципальные экологические цели и государственные стратегии устойчивого развития ОАЭ. Наша деятельность соответствует стандартам и инициативам муниципалитета Дубая, Tadweer Group (управление отходами Абу-Даби), Агентства по охране окружающей среды Абу-Даби (EAD) и Министерства изменения климата и окружающей среды ОАЭ (MOCCAE).",
    faqQ5: "Как жители ОАЭ могут сообщить о загрязнённом участке побережья?",
    faqA5: "Жители и гости страны могут предложить любую загрязнённую береговую линию или мангровый залив через форму на Стене сообщества. Выберите тип 'Рекомендация места', укажите пляж и эмират, опишите характер мусора и прикрепите фото или видео. Проверенные заявки добавляются в каталог для организации волонтёрских акций.",
  ...
  ar: {
    ...
    faqEyebrow: "حماية السواحل والأسئلة الشائعة",
    faqTitle: "الأسئلة الشائعة حول تنظيف شواطئ الإمارات",
    faqIntro: "إرشادات أساسية حول مشاركة المتطوعين، والمواقع الساحلية ذات الأولوية، وإدارة النفايات البحرية، والشراكات البيئية في أنحاء الدولة.",
    faqQ1: "كيف يمكن للمتطوعين الانضمام لحملات تنظيف الشواطئ في دبي وأبوظبي والإمارات؟",
    faqA1: "يمكن للمتطوعين المشاركة بحرية عبر مبادرة Clean Shores UAE دون أي رسوم تسجيل. استكشف دليل السواحل للعثور على المواقع النشطة في دبي وأبوظبي والشارقة وعجمان، أو تابع جدار المجتمع لمعرفة مواعيد الحملات القادمة. كما يمكنك تنظيم حملتك الخاصة مع الأصدقاء أو الزملاء وتوثيق أثركم ومشاركة تقرير الحملة على جدار المجتمع.",
    faqQ2: "ما هي الشواطئ والمواقع الساحلية في الإمارات الأكثر حاجة لحملات التنظيف؟",
    faqA2: "تشمل المواقع ذات الأولوية الشواطئ العامة الحيوية مثل شاطئ جميرا المفتوح وكايت بيتش في دبي، وشاطئ الحيرة في الشارقة حيث تتراكم المخلفات البلاستيكية باستمرار. كما تشمل الموائل الطبيعية الحساسة كمحمية السعديات البحرية في أبوظبي (موطن تعشيش سلاحف منقار الصقر) وشاطئ القرم بالزوراء في عجمان، والتي تتطلب تنظيفاً دقيقاً لجمع البلاستيك الدقيق وشباك الصيد العالقة.",
    faqQ3: "ما هي أنواع المخلفات البحرية الأكثر شيوعاً على شواطئ الإمارات؟",
    faqA3: "تظهر عمليات التدقيق الساحلي في الإمارات أن النفايات الأكثر شيوعاً هي البلاستيك أحادي الاستخدام (عبوات المياه، الأغطية، قشات الشرب، وأغلفة الأطعمة)، وقطع الفلين الصناعي (البوليسترين)، وشباك وخيوط الصيد المهملة. وتساعد إزالة هذه المواد في منع تفتتها إلى جزيئات بلاستيكية دقيقة تضر بالأحياء البحرية والشعب المرجانية في مياه الخليج العربي.",
    faqQ4: "كيف تتوافق Clean Shores UAE مع الأطر والمبادرات البيئية الرسمية في الإمارات؟",
    faqA4: "تعد Clean Shores UAE منصة مجتمعية مستقلة تتماشى مع الأهداف البيئية للبلديات والأجندة الوطنية للاستدامة في الإمارات. تدعم فعالياتنا إرشادات وجهود بلدية دبي، ومجموعة تدوير (إدارة النفايات في أبوظبي)، وهيئة البيئة – أبوظبي (EAD)، ووزارة التغير المناخي والبيئة (MOCCAE)، مما يعزز السياسات الوطنية للحد من استهلاك البلاستيك.",
    faqQ5: "كيف يمكن لسكان الإمارات الإبلاغ عن شاطئ متضرر أو ترشيحه للتنظيف؟",
    faqA5: "يمكن للمواطنين والمقيمين والزوار ترشيح أي شاطئ مهمل أو خور لأشجار القرم عبر نموذج جدار المجتمع. اختر نوع 'اقتراح موقع تنظيف'، وحدد الشاطئ والإمارة، وصف طبيعة المخلفات، وأرفق صوراً أو مقاطع فيديو. يتم تدقيق المشاركات وجدولتها كأولوية لحملات المتطوعين.",
    ...
    footerNavFaq: "دليل الأسئلة الشائعة",
...
function applyLanguage(lang) {
  ...
  [
    "brandTitle", "brandSubtitle", "navMission", "navMedia", "navSpots", "navCommunity", "navFaq",
    ...
    "submitButton", "feedTitle", "feedIntro",
    "faqEyebrow", "faqTitle", "faqIntro",
    ...
    "footerNavMission", "footerNavMedia", "footerNavSpots", "footerNavCommunity", "footerNavFaq",
